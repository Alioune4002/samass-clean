...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`md:static fixed top-0 left-0 h-full w-64 max-w-[80%] bg-[#111111] border-r border-gray-800 p-6 flex flex-col transform transition-transform duration-200 ${
